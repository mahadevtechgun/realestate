...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaTimes, FaGoogle, FaFacebook } from 'react-icons/fa';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-[#171B22] rounded-2xl max-w-md w-full p-6 border border-white/10 shadow-2xl relative animate-fade-up">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-[#F8F8F8]">Welcome Back</h3>
          <p className="text-[#A0A0A0] text-sm mt-1">Sign in to your account</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 text-[#A0A0A0] text-sm cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-[#0F1115] text-[#D4AF37] cursor-pointer" disabled={isLoading} />
              Remember me
            </label>
            <button
              type="button"
        ...
        <div className="flex gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 bg-[#0F1115] py-3 rounded-xl text-[#F8F8F8] border border-white/10 hover:border-[#D4AF37] hover:text-[#D4AF37] transition">
            <FaGoogle /> Google
          </button>
          <button className="flex-1 flex items-center justify-center gap-2 bg-[#0F1115] py-3 rounded-xl text-[#F8F8F8] border border-white/10 hover:border-[#D4AF37] hover:text-[#D4AF37] transition">
            <FaFacebook /> Facebook
